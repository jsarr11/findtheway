///////////////// FOR UNIFIED SCRIPT IN THE FUTURE //////////////////////
// If gameType isn't defined by the page, default to 'prim' or 'kruskal'.
// Usually, your HTML page sets it before this script runs.
const effectiveGameType = (typeof gameType !== 'undefined') ? gameType : 'prim';
...
function playGame(level) {
    ...
    window.location.href = `/main-game-${effectiveGameType}?level=${level}`;
}
...
function playCustomGame() {
    ...
    window.location.href = `/main-game-${effectiveGameType}?level=custom&vertices=${vertices}&edges=${edges}&minWeight=${minWeight}&maxWeight=${maxWeight}`;
}
